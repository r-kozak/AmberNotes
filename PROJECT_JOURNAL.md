...
- [ ] Крок 4: Базовий UI (Головне вікно з кнопкою "Створити" і тестовим записом).

## Журнал сесій (Session Log)
### [Поточна дата] - Ініціалізація проєкту
...
- **Наступний крок:** Зробити базовий, початковий "Hello World" UI.